...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno){
        ...
        String valoccupational[] = {"Salaried", "Self-Employed", "Bussiness", "Student", "Other"};
        occupation = new JComboBox(valoccupational);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            Conn c = new Conn();
            String query = "insert into signuptwo values('"+formno+"', '"+sreligion+"', '"+sincome+"', '"+seducation+"', '"+soccupation+"', '"+span+"', '"+saadhar+"', '"+sexistingacc+"')";
