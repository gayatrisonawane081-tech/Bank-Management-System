...
public class SignupOne extends JFrame implements ActionListener {
    ...
    long random;
    JTextField nameTextField, emailTextField, addressTextField, cityTextField, stateTextField, pincodeTextField;
    JButton next;
    ...
    SignupOne(){
        ...
        pincodeTextField.setBounds(300, 490, 400, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            Conn c = new Conn();
            String query = "insert into signup values('"+formno+"', '"+name+"', '"+dob+"', '"+gender+"', '"+email+"', '"+address+"', '"+city+"', '"+state+"', '"+pincode+"')";
